...
class CoverGenerator:
    ...
    def __init__(self):
        with open("../templates/cover_for_rsg.html", "r", encoding="utf8") as template_file:
    ...
    def generate(self, live_run: LiveRunData, world_data: WorldData, video_path: Path) -> Path:
        ...
        with open(config.video_dir / f'cover world[{world_data.data.id}].html', 'w', encoding="utf8") as html_file:
